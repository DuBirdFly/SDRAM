...
module sdr (Clk, Cke, Cs_n, Ras_n, Cas_n, We_n, Addr, Ba, Dq, Dqm);
...
`endif
            ...
            Dq_reg = #tAC Dq_dqm;
            if (Debug) begin
                $display("%m : at time %t READ : Bank = %d Row = %d, Col = %d, Dqm = %b, Data = 0x%h", $time, Bank, Row, Col, Dqm_reg0, Dq_reg);
            end
    ...
    //* Timing Parameters for SG-75 (133 MHz @ CL3) *****************************************
    specify
        specparam
            tCK3 =  7.5,
    ...
    endspecify
    //* Timing Parameters for W9825G6DH-6 (166 MHz @ CL3) ********************************
    /*
    specify
        specparam
            tAH  =  0.8,
